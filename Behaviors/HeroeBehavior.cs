...
public class HeroeBehavior : MonoBehaviour {  
    ...
    void Start () {  
        ...
        render.material.SetColor("_Color", new Color(0,0,255));
    ...
    void Update () {  
    	...
    	float new_x = (friend_position.x + enemy_position.x)/2;
    	float new_z = (friend_position.z + enemy_position.z)/2;

    	float new_y = (friend_position.y + enemy_position.y)/2;
